...
constexpr int 	num_items = 40,			// número de ítems a producir/consumir
					num_hebras_prod = 5,		// número de hebras productoras
...
{
private:
	static const int 	num_celdas_total = 10;	// número de celdas del buffer
...
{
   // esperar bloqueado hasta que 0 < num_celdas_ocupadas -> esperar hasta que haya alguna celda ocupada
